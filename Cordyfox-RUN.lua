...
--              [ F10 ]             Emergency -Coiste Bodhar Mode
--              [ ALT+F10 ]         Toggle Kiting Mode
--              [ F11 ]             Emergency -MDT Mode
--              [ F12 ]             Update Current Gear / Report Current Status
--              [ CTRL+F12 ]        Cycle Idle Modes
--              [ ALT+F12 ]         Cancel Emergency -Coiste Bodhar/-MDT Mode
...
function user_setup()
    state.OffenseMode:options('Normal', 'Accuracy', 'MaxAccuracy', 'Tank', 'TankAccuracy')
    state.WeaponskillMode:options('Normal', 'Accuracy')
    state.HybridMode:options('Normal', 'DT')
    state.CastingMode:options('Normal', 'Resistant')
    state.IdleMode:options('Normal', 'DT', 'Refresh')
    state.PhysicalDefenseMode:options('Coiste Bodhar', 'HP')
    ...
    if player.sub_job == 'BLU' then
        ...
        send_command('bind numpad+ input /ma "Cursed Sphere" <stnpc>')
    elseif player.sub_job == 'DRK' then
    ...
    send_command('bind ^numpad3 input /ws "Ground Strike" <t>')--;input /p Ground Strike')
    send_command('bind ^numpad4 input /ws "Herculean Slash" <t>')
    send_command('bind ^numpad5 input /ws "Shockwave" <t>')
    send_command('bind ^numpad6 input /ws "Upheaval" <t>')
    send_command('bind ^numpad7 input /ws "Full Break" <t>')
...
function init_gear_sets()
    ...
    sets.precast.FC = {
        ...
        ring1= {name="Moonlight Ring", bag="wardrobe1"},
        ring2= {name="Moonlight Ring", bag="wardrobe2"},
    ...
    sets.precast.WS['Resolution'].Accuracy = set_combine(sets.precast.WS['Resolution'], {
        ammo="Voluspa Tathlum",
    ...
    sets.precast.WS['Dimidiation'].Accuracy = set_combine(sets.precast.WS['Dimidiation'], {
        ammo="Voluspa Tathlum",
        body="Adhemar Jacket +1",
        legs="Samnuha Tights",
    ...
    sets.precast.WS['Fell Cleave'].Accuracy = set_combine(sets.precast.WS.Accuracy, {
        ear2="Ishvara Earring",
        back=gear.RUN_WSD_Cape,
        waist="Sailfi Belt +1",
    })
    ...
    sets.precast.WS['Steel Cyclone'].Accuracy = sets.precast.WS['Fell Cleave'].Accuracy
    sets.precast.WS['Steel Cyclone'].Safe = sets.precast.WS['Fell Cleave'].Safe

    sets.precast.WS['Upheaval'] = sets.precast.WS['Resolution']
    sets.precast.WS['Upheaval'].Accuracy = sets.precast.WS['Resolution'].Accuracy
    ...
    sets.midcast.Regen = set_combine(sets.midcast['Enhancing Magic'], {head="Rune. Bandeau +2swn ", neck="Sacro Gorget"})
    ...
    sets.defense.PDT = {
        ...
        body = "Nyame Mail",
        hands= "Turms Mittens +1",
        legs = "Nyame Flanchard", --7/0
        feet = "Turms Leggings +1",
        neck = "Loricate Torque +1", --7/7
        ear1 = "Eabani Earring",
...
--[[     sets.engaged = {
    ...
    sets.engaged.Tank = set_combine(sets.engaged.MaxAccuracy, {
        ammo="C. Palug Stone",
        head="Carmine Mask +1",
        body="Carm. Sc. Mail +1",
    ...
    sets.engaged.TankAccuracy = set_combine(sets.engaged, {
    ...
    sets.engaged.Accuracy.DT = set_combine(sets.engaged.Accuracy, sets.Hybrid)
    sets.engaged.MaxAccuracy.DT = set_combine(sets.engaged.MaxAccuracy, sets.Hybrid)
    sets.engaged.Tank.DT = set_combine(sets.engaged.Tank, sets.Hybrid)
    sets.engaged.TankAccuracy.DT = set_combine(sets.engaged.TankAccuracy, sets.Hybrid)
...
--    end
    ...
    if buff == "doom" then
        if gain then
            ...
            send_command('@input /p I\'m doomed! <call14>')
