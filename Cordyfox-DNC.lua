-------------------------------------------------------------------------------------------------------------------
--  Asura.Cordyfox DNC GearSwap .lua
-------------------------------------------------------------------------------------------------------------------
...
• need Fast Cast feet (roll Herc feet augs)
...
function user_setup()
    ...
    state.WeaponSet = M{['description']='Weapon Set','DD','Tank','Cleave','SixStep','DI','H2H'}
    ...
    send_command('bind ^numpad9 gs c toggle ClosedPosition')
    ...
    elseif player.sub_job == 'THF' then
        send_command('bind ^numpad/ input /ja "Steal" <me>')
        send_command('bind ^numpad* input /ja "Mug" <me>')
    ...
    send_command('bind ^numpad1 input /ws "Pyrrhic Kleos" <t>')
    ...
    send_command('bind !numpad2 input /ws "Backhand Blow" <t>')
...
function init_gear_sets()
    ...
    sets.idle.DT = set_combine(sets.idle, {
        ...
        feet = "Gleti's Boots", --4/4
        neck = "Warder's Charm +1",
        ear2 = "Odnowa Earring +1",
        ring1= "Moonlight Ring", --0/4
    ...
    sets.DD = {main="Terpsichore", sub="Gleti's Knife"}
    sets.Tank = {main="Terpsichore", sub="Acrontica"}
    sets.Cleave = {main="Tauret", sub="Ternion Dagger +1"}
    sets.SixStep = {main="Athame", sub="Legion Scutum"}
    sets.DI = {main="Terpsichore", sub="Voluspa Knife"}
    sets.H2H = {main="Kaja Knuckles"}
...
function job_buff_change(buff,gain)
	...
	if buff == "charm" then
        if gain then
            send_command('@input /p <me> is Charmed! Stay on your toes!')
        else
...
organizer_items = {
	...
	chakram="Albin Bane",
    -- AF
    artifact_head="Maxixi Tiara +2",
    artifact_body="Maxixi Casaque +2",
    artifact_hands="Maxixi Bangles +2",
    artifact_legs="Maxixi Tights +2",
    artifact_feet="Maxixi Toe Shoes +2",
    -- Relic
    relic_head="Horos Tiara +3",
    relic_body="Horos Casaque +3",
    relic_hands="Horos Bangles +3",
    relic_legs="Horos Tights +3",
    relic_feet="Horos T. Shoes +3",
    -- Empyrean
    empy_head="Maculele Tiara +1",
    empy_body="Macu. Casaque +1",
    empy_hands="Maculele Bangles +1",
    empy_legs="Maculele Tights +1",
    empy_feet="Macu. Toe Shoes +1",
}